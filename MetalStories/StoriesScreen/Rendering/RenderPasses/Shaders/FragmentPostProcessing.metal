...
float3 fire_and_ice(float3 rgb) {
    const auto contrastRGB = catmull_rom_5_rgb(0.f,
                                               0.22f,
                                               0.5f,
                                               0.78f,
                                               1.f,
    ...
    const auto filteredR = catmull_rom_5_single(0.f,
                                                0.22f,
                                                0.5f,
                                                0.78f,
                                                1.f,
                                                contrastRGB.r);
    const auto filteredG = catmull_rom_5_single(0.f,
                                                0.21f,
                                                0.5f,
                                                0.79f,
                                                1.f,
                                                contrastRGB.g);
    const auto filteredB = catmull_rom_5_single(0.f,
                                                0.3f,
                                                0.48f,
                                                0.7f,
                                                1.f,
...
float3 sepia(float3 rgb) {
    const auto luma = luminance(rgb);
    const auto curveContrast = catmull_rom_5_single(0.f,
                                                    0.2f,
                                                    0.5f,
                                                    0.8f,
                                                    1.f,
...
float3 cross_process_film(float3 rgb) {
    ...
    const auto curveR = catmull_rom_5_single(0.f,
                                             0.22f,
                                             0.5f,
                                             0.78f,
                                             1.f,
                                             mixed.r);
    const auto curveG = catmull_rom_5_single(0.f,
                                             0.23f,
                                             0.5f,
                                             0.77f,
                                             1.f,
                                             mixed.g);
    const auto curveB = catmull_rom_5_single(0.f,
                                             0.24f,
                                             0.5f,
                                             0.76f,
                                             1.f,
...
float3 teal_orange_cinema(float3 rgb) {
    const auto curved = catmull_rom_5_rgb(0.f,
                                          0.18f,
                                          0.52f,
                                          0.85f,
                                          1.f,
...
float3 matte_vintage(float3 rgb) {
    ...
    const auto flattened = catmull_rom_5_rgb(0.08f,
                                             0.28f,
                                             0.53f,
                                             0.77f,
                                             0.95f,
...
float3 bleach_bypass(float3 rgb) {
    ...
    const auto contrast = catmull_rom_5_rgb(0.f,
                                            0.16f,
                                            0.5f,
                                            0.88f,
                                            1.f,
...
float3 noir_chrome(float3 rgb) {
    const auto luma = luminance(rgb);
    const auto bw = catmull_rom_5_single(0.1f,
                                         0.2f,
                                         0.7f,
                                         0.8f,
                                         0.9f,
